...
@WebServlet(
		...
		urlPatterns = { 
				"/TheatresDeleteServlet",
				"/TheatresDelete"
		})
public class TheatresDeleteServlet extends HttpServlet 
{
			...
			throws ServletException, IOException
	{
		...
		int rowsDeleted = TheatresDAO.deleteEmployeeById(id);
